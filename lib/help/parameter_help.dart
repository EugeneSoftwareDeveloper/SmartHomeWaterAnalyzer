  ...
  static ParameterHelp _ec(NormsProfile profile) {
    final ranges = switch (profile) {
      ...
      _ => const [
        ...
        HelpRange(
          label: 'Жёсткая',
          range: '500 – 1000 µС/см',
          note: 'Много минералов, накипь в чайнике',
          color: _HelpPalette.acceptable,
        ),
        HelpRange(
          label: 'Очень жёсткая',
          range: '1000 – 1500 µС/см',
