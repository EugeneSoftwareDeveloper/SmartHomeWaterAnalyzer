...
| [05-state-and-storage.md](./05-state-and-storage.md) | Разработчик новых фич | Riverpod-провайдеры, схема drift и миграции, SharedPreferences, локализация, навигация, error handling |
...
История изменений — в [`../CHANGELOG.md`](../CHANGELOG.md): по версии на релиз, с объяснением, зачем менялось.
